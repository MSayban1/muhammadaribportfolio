          ...
          once: true
            ...
            <div className="card-elevated p-6">
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => <motion.a key={info.label} href={info.href} className="flex items-center gap-4 p-4 rounded-2xl bg-secondary/50 hover:bg-secondary transition-colors" whileHover={{
                x: 5
              }} initial={{
                opacity: 0,
                y: 10
            ...
            <div className="card-elevated p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                {socialIcons.map((social, index) => <motion.a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center gap-2 p-4 rounded-2xl border ${social.color} hover:scale-105 transition-transform`} whileTap={{
                scale: 0.95
              }} initial={{
                opacity: 0,
                y: 10
